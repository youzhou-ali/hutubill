...
import guilistener.ToolBarListener;
...
public class MainPanel extends JPanel {
    ...
    public JButton bSpendDetail = new JButton();
    ...
    public MainPanel() {
        ...
        GUIUtil.setImageIcon(bSpendDetail, "category1.png", "消费记录");
    ...
    private void addListener() {
        ...
        bSpendDetail.addActionListener(listener);
